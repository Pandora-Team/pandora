    ...
    async submitForm() : Promise<void> {
        ...
        if (!this.$v.$invalid) {
            try {
                ...
                this.$mainStore.notification.changeNotification(true, this.$mainNotification.successAuth)
                ...
                this.$mainStore.notification.changeNotification(true, this.$mainNotification.failedAuth)
