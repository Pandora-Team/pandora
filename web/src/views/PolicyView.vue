<template>
    <div class="policy">
        ...
        <p>
            ...
            применяется ко
            всей информации, которую Оператор может получить о посетителях веб-сайта https://pandora-kpop.ru.
        </p>
        ...
        <p>
            ...
            обеспечивающих их доступность в сети интернет по сетевому адресу https://pandora-kpop.ru.
        </p>
        <p>
        ...
        <p>
            ...
            или определяемому
            Пользователю веб-сайта https://pandora-kpop.ru.
        </p>
        <p>
        ...
        <p>2.10. Пользователь – любой посетитель веб-сайта https://pandora-kpop.ru.</p>
        <p>
        ...
        <p>
            ...
            Пользователем самостоятельно через специальные формы, расположенные на сайте https://pandora-kpop.ru или
        ...
        <p>
            ...
            Оператору
            уведомление посредством электронной почты на электронный адрес Оператора evsikovoleg145@gmail.com с пометкой
            «Отзыв
        ...
        <p>
            ...
            персональных данных, обратившись к Оператору с помощью электронной почты evsikovoleg145@gmail.com.
        </p>
        <p>
