    ...
    async submitForm(): Promise<void> {
        ...
        if(!this.$v.$invalid) {
            ...
            try {
                ...
                this.$mainStore.notification.changeNotification(true, this.$mainNotification.successReg)
                ...
                this.$mainStore.notification.changeNotification(true, this.$mainNotification.failedReg)
